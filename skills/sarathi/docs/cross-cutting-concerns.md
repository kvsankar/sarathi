...
| Requirement links | Requirement and acceptance IDs. | Component and test obligation IDs. | PR assignment and planned coverage. | `.sdlc/test-traceability.yaml` as a claim map; inspect linked tests and their pass/fail checks. |
